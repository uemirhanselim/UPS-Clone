...
const OrderCard = ({ item }: Props) => {
    ...
    const navigaton = useNavigation<OrderScreenNavigationProp>()
    return (
        <TouchableOpacity onPress={() => navigaton.navigate('Order', {order: item})}>
            <Card containerStyle={tw("px-5 round-lg")}>
